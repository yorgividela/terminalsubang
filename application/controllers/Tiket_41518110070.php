...
class Tiket_41518110070 extends CI_Controller {
	...
	public function cekjadwal($tgl='' , $asl='', $tjn=''){
		...
		$data['jadwal'] = $this->db->query("SELECT * FROM tbl_jadwal_41518110070 LEFT JOIN tbl_bus on tbl_jadwal_41518110070.kd_bus = tbl_bus.kd_bus LEFT JOIN tbl_tujuan_41518110070 on tbl_jadwal_41518110070.kd_tujuan = tbl_tujuan_41518110070.kd_tujuan WHERE tbl_jadwal_41518110070.wilayah_jadwal ='".$tujuan."' AND tbl_jadwal_41518110070.kd_asal = '".$asal."'")->result_array();
		// die(print_r($data));
	...
	public function beforebeli($jadwal="",$asal='',$tanggal=''){
		...
		if ($this->session->userdata('username')){
			...
			$data['asal'] =  $this->db->query("SELECT * FROM tbl_tujuan_41518110070
               WHERE kd_tujuan ='".$asal."'")->row_array();
			$data['jadwal'] = $this->db->query("SELECT * FROM tbl_jadwal_41518110070 LEFT JOIN tbl_bus on tbl_jadwal_41518110070.kd_bus = tbl_bus.kd_bus LEFT JOIN tbl_tujuan_41518110070 on tbl_jadwal_41518110070.kd_tujuan = tbl_tujuan_41518110070.kd_tujuan WHERE kd_jadwal ='".$id."'")->row_array();
	...
	public function caritiket(){
		// die(print_r($POST));
		$id = $this->input->post('kodetiket');
		$sqlcek = $this->db->query("SELECT * FROM tbl_order_41518110070 LEFT JOIN tbl_bus on tbl_order_41518110070.kd_bus = tbl_bus.kd_bus LEFT JOIN tbl_jadwal_41518110070 on tbl_order_41518110070.kd_jadwal = tbl_jadwal_41518110070.kd_jadwal WHERE kd_order ='".$id."'")->result_array();
		if ($sqlcek == NULL) {
	...
	public function cetak($id=''){
		$this->getsecurity();
		$order = $id;
		$data['cetak'] = $this->db->query("SELECT * FROM tbl_order_41518110070 LEFT JOIN tbl_bus on tbl_order_41518110070.kd_bus = tbl_bus.kd_bus LEFT JOIN tbl_jadwal_41518110070 on tbl_order_41518110070.kd_jadwal = tbl_jadwal_41518110070.kd_jadwal LEFT JOIN tbl_tujuan_41518110070 on tbl_jadwal_41518110070.kd_tujuan = tbl_tujuan_41518110070.kd_tujuan WHERE kd_order ='".$id."'")->result_array();
